...
const curriculumItems = [
  {
    title: "고전 읽기",
    icon: BookOpen,
    description: "HRA의 고전 읽기 과정은 국내외 대학에서 권장하는 고전 명작을 중심으로 진행됩니다. 참가자들은 책을 읽고 텍스트를 작성한 후, 발표와 토론을 통해 내용을 심층적으로 이해합니다. 이 과정을 통해 사고의 폭을 넓히고, 핵심을 정리하는 능력과 함께 글쓰기 및 발표 역량을 체계적으로 향상시킬 수 있습니다.",
  },
  {
    title: "경영서",
    icon: Briefcase,
  ...
  },
  {
    title: "특강",
    icon: Mic,
    description: "HRA에서는 다양한 분야의 전문가를 초청하여 특강을 진행합니다. 스피치 훈련을 통해 표현력과 전달력을 향상시키고, 영어 세션을 통해 글로벌 커뮤니케이션 역량을 기릅니다. 또한 취업 특강을 통해 진로 설정과 취업 준비에 필요한 실질적인 정보를 제공합니다. 이를 통해 참가자들은 자신의 역량을 보다 균형 있게 발전시킬 수 있습니다.",
  },
  {
    title: "하계 인턴",
    icon: Building,
